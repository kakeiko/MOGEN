...
import 'package:mogen/services/gastos_service.dart';




class TelaAddGastos extends StatelessWidget {
  final int? id;
const TelaAddGastos({ Key? key, required this.id }) : super(key: key);
          ...
          children: [
            ...
            child: Column(
              ...
              children: [
                ...
                FormBuilder(
                  ...
                  child: Padding(
                    ...
                    child: FormBuilderDropdown(
                      name: 'pagamentos',
                      items: 
                        pagamentosOptions.map((pagamentos) => DropdownMenuItem(
                                alignment: AlignmentDirectional.center,
                                value: pagamentos,
                ...
                ElevatedButton(
                  onPressed: (){
                    GastosService service = GastosService();
                    ...
                    service.register(_nomeController.text, categoria_value, _valorController.text, pagamento_value, _bancoController.text, id).then((result){
                      if (result){
                        Navigator.pop(context);
                      }
                    });
